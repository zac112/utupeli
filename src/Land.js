...
class Land extends React.Component{
	...
	render(){
		var text = <div>Land. Fund expeditions to get more. Funding expeditions costs scouts and gold, additionally each piece of land is harder to find and thus costs more. Your next piece of land will cost {this.props.landScoutCost} scouts and {this.props.landGoldCost} gold.</div>
		var limit = ""
